...
### Localization
The localization of the gamestring can also be passed in using `StormLocale`. By default it is ENUS. The localization is used for the scaling text (e.g. (+4% per level)) and to determine the decimal separator of all numbers.
